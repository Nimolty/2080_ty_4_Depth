...
#                    writer.add_scalar(f'Validation/Validation Pos Loss', np.mean(val_pos_loss), epoch)
#                    writer.add_scalar(f'Validation/Validation Prob Loss', np.mean(val_prob_loss), epoch)
#                    
#                    writer.add_scalar(f"Validation Metrics/ ACC", np.mean(val_acc), epoch)
#                    writer.add_scalar(f"Validation Metrics/ a1", np.mean(val_a1), epoch)
#                    writer.add_scalar(f"Validation Metrics/ a2", np.mean(val_a2), epoch)
#                    writer.add_scalar(f"Validation Metrics/ a3", np.mean(val_a3), epoch)
#                    writer.add_scalar(f"Validation Metrics/ rmse", np.mean(val_rmse), epoch)
#                    writer.add_scalar(f"Validation Metrics/ rmse_log", np.mean(val_rmse_log), epoch)
#                    writer.add_scalar(f"Validation Metrics/ mae", np.mean(val_mae), epoch)
#                    writer.add_scalar(f"Validation Metrics/ abs_rel", np.mean(val_abs_rel), epoch)
#                    
#                    writer.add_scalar(f"Validation Metrics/ ADD AUC", val_add_results["add_auc"], epoch)
#                    writer.add_scalar(f"Validation Metrics/ ADD MEDIAN", val_add_results["add_median"], epoch)
#                    writer.add_scalar(f"Validation Metrics/ ADD MEAN", val_add_results["add_mean"], epoch)
#                    writer.add_scalar(f"Validation Metrics/ ADD AUC THRESH", val_add_results["add_auc_thresh"], epoch)
