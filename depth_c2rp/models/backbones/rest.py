...
class ResT(nn.Module):  
    def __init__(self, model_name: str = 'S') -> None:
        ...
        self.stem = Stem(11, embed_dims[0])
...
#    model = ResT('S')
#    model.load_state_dict(torch.load("/DATA/disk1/hyperplane/Depth_C2RP/Code/Ours_Code/pretrained/rest_small.pth", map_location='cpu'), strict=False)
    
#    model = ResT("B")
#    model_path = "/DATA/disk1/hyperplane/Depth_C2RP/Code/Ours_Code/pretrained/rest_base.pth"
#    load_pretrained(model, model_path)
    
    
    model = ResT("L")
    model_path = "/DATA/disk1/hyperplane/Depth_C2RP/Code/Ours_Code/pretrained/rest_large.pth"
    load_pretrained(model, model_path)
