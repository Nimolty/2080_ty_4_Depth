...
from depth_c2rp.models.layers import DropPath
...
class PoolFormer(nn.Module):     
    def __init__(self, model_name: str = 'S24') -> None:
        ...
        self.patch_embed = PatchEmbed(7, 4, 2, 11, embed_dims[0])
...
if __name__ == '__main__':
    ...
    model_path = "/DATA/disk1/hyperplane/Depth_C2RP/Code/Ours_Code/pretrained/poolformer_m36.pth.tar"
#    checkpoint = torch.load("/DATA/disk1/hyperplane/Depth_C2RP/Code/Ours_Code/pretrained/poolformer_m36.pth.tar", map_location='cpu')
#    print("checkpoint", checkpoint.keys())
#    model.load_state_dict(torch.load("/DATA/disk1/hyperplane/Depth_C2RP/Code/Ours_Code/pretrained/poolformer_m36.pth.tar", map_location='cpu'), strict=False)
    load_pretrained(model, model_path)
    x = torch.randn(1, 11, 224, 224)
    feats = model(x)
    for y in feats:
        print(y.shape)
