...
#    model = ConvNeXt('T')
#    model_path = f"/DATA/disk1/hyperplane/Depth_C2RP/Code/Ours_Code/pretrained/convnext_tiny_1k_224_ema.pth"
    
#    model = ConvNeXt('S')
#    model_path = f"/DATA/disk1/hyperplane/Depth_C2RP/Code/Ours_Code/pretrained/convnext_small_1k_224_ema.pth"
    
    model = ConvNeXt('B')
    model_path = f"/DATA/disk1/hyperplane/Depth_C2RP/Code/Ours_Code/pretrained/convnext_base_1k_224_ema.pth"
